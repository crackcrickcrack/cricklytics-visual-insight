  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <a href="/matches" className="text-cricket-green hover:underline text-sm font-medium">View All</a>
            </div>
        ...
        <section className="py-12 px-4 bg-secondary/50">
          <div className="container mx-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <a href="/players" className="text-cricket-green hover:underline text-sm font-medium">View All Players</a>
            </div>
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto">
            <h2 className="text-2xl font-bold mb-6">Stats & Insights</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-cricket-blue/5 border border-cricket-blue/20 rounded-lg p-4">
            ...
            <div className="mt-12 text-center">
              <a href="/dashboard" className="inline-block bg-cricket-green text-white px-6 py-3 rounded-lg font-medium hover:bg-cricket-green/90 transition-colors">
        ...
        {/* Newsletter Section */}
        <section className="py-12 px-4 bg-cricket-blue text-white">
          <div className="container mx-auto max-w-xl text-center">
            <h2 className="text-2xl font-bold mb-4">Stay Updated</h2>
            <p className="mb-6">Get the latest cricket insights, match predictions and player analysis straight to your inbox.</p>
            
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 rounded-lg flex-grow text-foreground"
              />
              <button className="bg-cricket-yellow text-cricket-blue px-6 py-2 rounded-lg font-medium hover:bg-cricket-yellow/90 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="bg-cricket-blue text-white py-8 px-4">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="font-bold text-lg mb-4">Cricklytics</h3>
