          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/" className="text-white/70 hover:text-cricket-green transition-colors">Home</a></li>
                <li><a href="/dashboard" className="text-white/70 hover:text-cricket-green transition-colors">Stats Dashboard</a></li>
                <li><a href="/compare" className="text-white/70 hover:text-cricket-green transition-colors">Player Comparison</a></li>
                <li><a href="/matches" className="text-white/70 hover:text-cricket-green transition-colors">Live Matches</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-white/70 hover:text-cricket-green transition-colors">API Documentation</a></li>
                <li><a href="#" className="text-white/70 hover:text-cricket-green transition-colors">Data Sources</a></li>
                <li><a href="#" className="text-white/70 hover:text-cricket-green transition-colors">FAQs</a></li>
                <li><a href="#" className="text-white/70 hover:text-cricket-green transition-colors">Blog</a></li>
              </ul>
            </div>
