...
<div className="w-full h-full bg-[url('https://img1.hscicdn.com/image/upload/f_auto,t_gn_w_1200/lsci/db/PICTURES/CMS/342100/342180.jpg')] bg-cover bg-center opacity-70 mix-blend-overlay"></div>
</div>
</div>
...
alt="Featured Player - Virat Kohli" 
className="w-full h-full object-cover object-top"
loading="lazy"
onError={(e) => {
e.currentTarget.src = "https://img1.hscicdn.com/image/upload/f_auto,t_gn_w_1200/lsci/db/PICTURES/CMS/342100/342180.jpg";
}}
/>
</div>
<div className="p-4">
...
<div className="text-center">
<p className="text-white font-bold text-lg">72</p>
<p className="text-white/70 text-xs">50s</p>
</div>
<div className="text-center">
<p className="text-white font-bold text-lg">13K+</p>
